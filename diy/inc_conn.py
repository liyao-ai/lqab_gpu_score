...
class Conn_mysql():
    ...
    def __init__(self, host='localhost', user='root', passwd='', db='', port=3306, charset="utf8"):
...
#rs_index_mysql = Conn_mysql(config.dic_config["host_mysql"],config.dic_config["user_mysql"],config.dic_config["pwd_mysql"], "lqab_index_" + config.dic_config["name_mysql_after"], int(config.dic_config["port_mysql"])) # 生成MYSQL数据库索引数据实例
